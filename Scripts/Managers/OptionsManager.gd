...
# General
@onready var lang_button = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/GENERAL/GeneralMarginContainer/GeneralVBoxContainer/LanguageHBoxContainer/LanguageOptionButton

# Audio
@onready var master_slider = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/AUDIO/AudioMarginContainer/AudioVBoxContainer/MasterVolumeHBoxContainer/MasterVolumeHSlider
@onready var music_slider = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/AUDIO/AudioMarginContainer/AudioVBoxContainer/MusicVolumeHBoxContainer/MusicVolumeHSlider
@onready var sfx_slider = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/AUDIO/AudioMarginContainer/AudioVBoxContainer/SFXVolumeHBoxContainer/SFXVolumeHSlider
@onready var mute_checkbox = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/AUDIO/AudioMarginContainer/AudioVBoxContainer/MuteAllHBoxContainer/MuteAllCheckBox

# Video
@onready var fullscreen_checkbox = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/VIDEO/VideoMarginContainer/VideoVBoxContainer/FullscreenHBoxContainer/FullscreenCheckBox
@onready var vsync_checkbox = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/VIDEO/VideoMarginContainer/VideoVBoxContainer/VSyncHBoxContainer/VSyncCheckBox

# Controls (placeholders)
@onready var invert_y_checkbox = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/CONTROLS/ControlsMarginContainer/ControlsVBoxContainer/InvertYAxisHBoxContainer/InvertYAxisCheckBox
@onready var input_device_button = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/CONTROLS/ControlsMarginContainer/ControlsVBoxContainer/InputDeviceHBoxContainer/InputDeviceOptionButton

# Accessibility
@onready var ui_scale_slider = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/ACCESSIBILITY/AccessibilityMarginContainer/AccessibilityVBoxContainer/UIScaleHBoxContainer/UIScaleHSlider
@onready var text_speed_slider = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/ACCESSIBILITY/AccessibilityMarginContainer/AccessibilityVBoxContainer/TextSpeedHBoxContainer/TextSpeedHSlider
@onready var colorblind_button = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/MarginContainer/TabContainer/ACCESSIBILITY/AccessibilityMarginContainer/AccessibilityVBoxContainer/ColorblindModeHBoxContainer/ColorblindModeOptionButton

@onready var back_button = $OptionsMenuTestMarginContainer/OptionsMenuTestVBoxContainer/BackButton
